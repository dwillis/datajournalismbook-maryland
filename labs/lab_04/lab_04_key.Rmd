...
**Q1.** You've been assigned to write about Maryland political committees' use of Facebook advertising. There's a category column in the data that has values for different kinds of spending. One of them is "Media". You'll need to complete the following steps:
   ...
   5. Using that `payee_clean` column in your new dataframe, write code to find all of the spending where Facebook is the payee and calculate the total amount of spending for each committee and present the results showing the committee that spent the most first.
...
**A2.** The top ten are mostly, but not entirely, candidates for governor in the 2022 primary election. Billy Boniface is a candidate for Harford County executive, for example. The top spender is the campaign of Ashwani Jain, a Democratic gubernatorial candidate who lost in the primary. His Facebook ads were taken down by the platform because they did not comply with disclaimer rules (who paid for this ad).
...
**A3.** Both Wes Moore & Dan Cox's campaigns are missing from the list of top Facebook spenders. Moore definitely has run Facebook ads, but Cox appears to have only run a small amount, which seems unusual. Moore's campaign (both primary and general committees) has paid more than \$6.1 million to SKDK, a Democratic consulting firm that handles all kinds of campaign activities, including advertising. We don't see direct payments to Facebook because it's likely that SKDK is making those buys rather than the campaign itself.

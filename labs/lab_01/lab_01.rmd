...
**Task** Run the codeblock below to use glimpse to get a sense of the column names, types and sample data. **Q1** How many rows and columns does this dataframe have? **A1**
...
**Q2** Which West Virginia city provided the largest number of contributions? How many? **A2**

```{r}
```

**Q3** Which West Virginia city accounted for the fewest contributions? How many? **A3**
...
**Q5** What recipient got the largest total amount of money? How many contributions did they receive and what was the average donation? **A5**
...
**Q7**. Produce a summary table that has the following information for West Virginia as a whole (the whole state, not by city): \* count of contributions \* total amount of all contributions \* the average contribution amount \* the median contribution amount \* the smallest contribution amount \* the largest contribution amount

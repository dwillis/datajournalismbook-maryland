...
**A1** Engineering, Cooperative Education, with 314.28 seats
...
**A2** There are more than 150 that have been offered 21 times each.
...
**A3** Keith Yearwood of Geographical Sciences, with 58.
...
**A4** It would be useful to remove the rows where `instructors` was NA so that you only see records where there are instructors populated in the data.

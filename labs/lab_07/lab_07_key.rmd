...
**Q3** We're interested in knowing more about Montgomery County zip codes where overdose calls are coming from and the demographic characteristics they possess.
...
```{r}
speak_spanish_zips <- get_acs(geography='zcta', variables=c(speak_spanish='B06007_003'), state='MD', year=2019) %>%
   rename('speak_spanish'='estimate') %>%
   select(-variable)

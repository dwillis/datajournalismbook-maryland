...
**Q1** What is the Maryland jurisdiction with the lowest median age, according to the ACS 2020 5-year estimates? You will need to find the variable for median age first. **A1** Baltimore City, with an estimated median age of 35.5 years and a margin of error of 0.2 years.

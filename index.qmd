...
-   As such, the whole book -- authored in Quarto -- in its original form is [open sourced on Github](https://github.com/dwillis/datajournalismbook). Pull requests welcomed!
